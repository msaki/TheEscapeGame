...
local function showMain()   
   ...
   composer.removeScene("RightBase");
...
local function showBack()   
   ...
   composer.removeScene("RightBase");
   composer.gotoScene("BackBase", options);
...
local function showCeiling()   
   ...
   composer.removeScene("RightBase");
   composer.gotoScene("RightCeiling", options);
...
local function showFloor()   
   ...
   composer.removeScene("RightBase");
   composer.gotoScene("RightFloor", options);
...
function scene:create( event )
   ...
   local bg = display.newImage("RightBase.jpg");
...
function scene:show( event )
   ...
   if ( phase == "will" ) then
      ...
      local main = display.newText("Main", x+260, y, native.systemFont, 16)
      main:setFillColor (0, 0, 1)
      main:addEventListener("tap", showMain);
      local back = display.newText("Back", x-260, y, native.systemFont, 16)
      back:setFillColor (0, 0, 1)
      back:addEventListener("tap", showBack);
